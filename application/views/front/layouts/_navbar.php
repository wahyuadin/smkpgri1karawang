	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown <?php if($title == 'Sejarah' || $title == 'Visi & Misi' || $title == 'Struktur' || $title == 'Fasilitas'|| $title == 'Ekstrakurikullar') echo "active"; ?>">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<a class="dropdown-item" href="<?= base_url('profil/ekstrakurikullar') ?>">Ekstrakurirullar</a>
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="<?= base_url('jurusan/ap') ?>">Teknik Pemesinan</a>
					<a class="dropdown-item" href="<?= base_url('jurusan/ak') ?>">Teknik Mekanik Industri</a>
					<a class="dropdown-item" href="<?= base_url('jurusan/pm') ?>">Teknik Kendaraan Ringan</a>
				</div>
				</li>
